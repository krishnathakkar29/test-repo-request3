    ...
    <>
      {!allScores[team] ? (
        ...
        <>
          ...
          <div className="opaque-bg h-full w-full bg-black opacity-10 relative"></div>
          <div
            className={`bg-container bg-opacity-90 w-full h-full min-h-screen overflow-auto  bg-fixed bg-cover bg-no-repeat object-cover m-0 scrollbar-hide pl-32`}
          >
            <div
